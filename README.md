...
This function app automatically gathers and outputs budget consumption for the last 30 days by calling Azure API.  
  
It will also allow you to know if you already spent more money than you should have (actual spent money compared to monthly 'budget' amount for the last 30 days)  
